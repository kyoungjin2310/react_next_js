...
export default function PostForm({ me }: Props) {
  ...
  const mutation = useMutation({
    mutationFn: async (e: FormEvent) => {
      ...
      return fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/api/post`, {
        method: "post",
        credentials: "include",
        body: formData,
      });
    ...
    // onSuccess - 성공했을때
    // onMutate - mutation 함수가 실행됐을때
    // onError는 실패했을때
    // onSettled는 성공 or 에러가 끝났을때(mutation이 종료 되었을 때)

    //response, variable - e, context - onMutate에서 return 값
